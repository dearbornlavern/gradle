...
The "Selecion reasons" part of the dependency insight report will list the different reasons that a dependency was selected.
...
| By constraint : <text>
| Same as above, with the addition of a `because` text
